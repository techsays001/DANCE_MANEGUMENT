 ...
 */
public class StatusFragment3 extends Fragment {
View root;
...
SwipeRefreshLayout swipe;
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setHasOptionsMenu(true);
         root= inflater.inflate(R.layout.fragment_status3, container, false);
        loadProducts();
       ...
       /* mySwipeRefreshLayout=findViewById(R.id.swipe);
        ...
        recyclerView = root.findViewById(R.id.recylcerViewcp);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        swipe=root.findViewById(R.id.swiperefreshp);
    ...
    private void loadProducts() {
         ...
         * */
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Dance_App_JPM/image_user_view.php",
